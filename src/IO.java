...
public class IO {
    ...
    //Ausgabe eines Errors mit Zeilenvorschub am Ende
    public static void errprintln(String str) {
        System.out.println(str);
    }

    //Zeitlich einstellbares Ausgeben eines Strings
    public static void timeprint(int time, String str) {
    ...
    //Zeitlich einstellbares Ausgeben eines Strings mit Zeilenvorschub am Ende
    public static void timeprintln(int time, String str) {
        timeprint(time, str);
        System.out.println();
    }

    //Langsames Ausgeben eines Strings mit Zeilenvorschub am Ende
    public static void slowprintln(String str) {
        timeprint(30, str);
        System.out.println();
    }

    //Langsames Ausgeben eines Strings ohne Zeilenvorschub am Ende    
    public static void slowprint(String str) {
        timeprint(30, str);
    }

    //Langsames Ausgeben eines Strings mit Zeilenvorschub am Ende
    public static void veryslowprintln(String str) {
        timeprint(600, str);
        System.out.println();
    }

    //Langsames Ausgeben eines Strings ohne Zeilenvorschub am Ende
    public static void veryslowprint(String str) {
        timeprint(600, str);
    }
    ...
    //Methode zum Löschen des Konsolenfensters
